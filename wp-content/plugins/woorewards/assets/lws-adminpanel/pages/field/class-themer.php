				...
				<div class='lws-themer-control'>
					...
					<div class='lws-themer-lightcont'>
						<div class='lws-themer-light-button'>
							<div class='lws-themer-lb-light lws-icon-lw_idea'></div>
							<div class='lws-themer-lb-dark lws-icon-lw_idea'></div>
						</div>
					</div>
				</div>
			</div>
EOT;
    ...
    protected function getBody()
    {
        ...
        $d = new \DOMDocument;
        $d->loadHTML('<?xml encoding="utf-8" ?>'.$page);
    ...
    protected function getBalises($cssFile)
    {
        ...
        if (false !== $values) {
            ...
            foreach ($balises->file as $balise) {
                if ($balise->Selector==':root') {
                    return $balise->Defaults;
                    break;
                }
