...
class Text extends \LWS\Adminpanel\Pages\Field
{
	public function input()
	{
		...
		if( empty($prop) )
		{
			echo "<input class='{$this->style}$class' type='$type' name='{$this->m_Id}' value='$mix'$size$maxlen$pattern$placeholder$required />";
		}
		else
		{
			echo "<div class='lwss-css-inputs'>";
			echo "<input class='{$this->style}$class' type='$type' data-css='$prop' data-lwss='$dft'$source value='$mix'$maxlen$pattern$placeholder$required />";
